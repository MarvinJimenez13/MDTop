...
public class ArtistaAdapter extends RecyclerView.Adapter<ArtistaAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.setListener(artista, holder.imgFoto, holder.tvNombre, listener);
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        void setListener(final Artista artista, View imgFoto, View nombre, final OnItemClickListener listener){
            containerMain.setOnClickListener(view -> listener.onItemClick(artista, imgFoto, nombre));//listener.onItemClick(artista));
