...
public class MainActivity extends AppCompatActivity implements OnItemClickListener {
    ...
    private final String DARK_SP = "spDarkTheme";
    ...
    private void configTheme(){
        ...
        mIsModeNight = sharedPreferences.getBoolean(DARK_SP, false);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        editor.putBoolean(DARK_SP, mIsModeNight);
        editor.apply();
     ...
     * ******/
    @Override
    public void onItemClick(Artista artista, View view, View nombre) {
        ...
        Pair<View, String> imgPair = Pair.create(view, getString(R.string.transition_name));
        //Pair<View, String> notasPair = Pair.create(notas, getString(R.string.transition_name_notas));
        Pair<View, String> nombrePair = Pair.create(nombre, nombre.getTransitionName());

        //ActivityOptions options = ActivityOptions.makeSceneTransitionAnimation(this, view, getString(R.string.transition_name));
        ActivityOptions options = ActivityOptions.makeSceneTransitionAnimation(this, imgPair, nombrePair);
