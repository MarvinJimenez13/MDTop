    ...
    private void configActionBar() {
        ...
        appBar.addOnOffsetChangedListener((appBarLayout, verticalOffset) -> {
            ...
            if(AppCompatDelegate.getDefaultNightMode() != AppCompatDelegate.MODE_NIGHT_YES){
                float porcentaje = Math.abs((float)Math.abs(verticalOffset)/appBarLayout.getTotalScrollRange() -1);
                int colorValue = (int)(porcentaje * 255);
        ...
        Glide.with(this).load(R.drawable.material).apply(options).into(imgCover);
...
*/
    ...
    public void onSetFecha() {
        ...
        buldier.setTheme(R.style.PickerDialogCut);
        buldier.setSelection(mArtista.getFechaNacimiento());

        CalendarConstraints.Builder constraints = new CalendarConstraints.Builder();
        constraints.setOpenAt(mArtista.getFechaNacimiento());
        buldier.setCalendarConstraints(constraints.build());
